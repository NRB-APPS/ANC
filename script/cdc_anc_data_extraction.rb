...
def start
  ...
  if CDCDataExtraction == 1
    ...
    $resultsOutput  << "PMTCT life long ART results..........................................................\n"
    $resultsOutput  << " total_pmtct_life_long_art_results: #{total_pmtct_life_long_art_results}\n pmtct_life_long_art_newly: #{pmtct_life_long_art_newly}\n pmtct_life_long_art_already: #{pmtct_life_long_art_already}\n"
  end
